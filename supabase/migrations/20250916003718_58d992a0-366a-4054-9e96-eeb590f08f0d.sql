...
DROP POLICY IF EXISTS "Anyone can insert threads" ON public.threads;
...
-- Create admin-only policies for full access including IP addresses (currently inactive)
...
CREATE POLICY "Public can insert threads"
ON public.threads
FOR INSERT
TO public
WITH CHECK (true);
